...
--  keybind.bind_command(keybind.mode.NORMAL, leader, leader_cmd, { noremap = true, silent = true })
--  keybind.bind_command(keybind.mode.NORMAL, local_leader, local_leader_cmd, { noremap = true, silent = true })
--
...
--
-- @param mode An edit mode from `c.keybind.mode`
