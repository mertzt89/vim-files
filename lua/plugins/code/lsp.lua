...
local function get_keys()
  ...
  _keys = {
    ...
    { "gr", fzf("lsp_references", { jump1 = true }), desc = "References" },
    { "gD", fzf("lsp_declarations", { jump1 = true }), desc = "Goto Declaration" },
    { "gi", fzf("lsp_implementations", { jump1 = true }), desc = "Goto Implementation" },
    { "gI", fzf("lsp_incoming_calls", { jump1 = true }), desc = "Incoming Calls" },
    { "gy", fzf("lsp_typedefs", { jump1 = true }), desc = "Goto T[y]pe Definition" },
